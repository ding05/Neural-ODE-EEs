# -*- coding: utf-8 -*-
"""12/16 Reproduce Neural CDEs.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/184-sTR8El3glz0jcOh1AX3FnARktrHTa

## Explore and Reproduce Neural CDEs

by Ding

[Paper](https://arxiv.org/abs/2005.08926)

[GitHub Repo](https://github.com/patrick-kidger/NeuralCDE)
...
!pwd
import os
os.chdir('/content/NeuralCDE')
!pwd

"""Try example.py.

An error displays no module named "controldiffeq."
"""

!python example/example.py

"""Paste the code in example.py.
...
"""Break up the example.py and look into the details.
...
**t** is a vector of time points; **X** is a matrix of the time points and correspoding values.
"""
...
X_interpolated = torchcde.NaturalCubicSpline(coeffs)

coeffs

"""An erorr displays no attribute "NaturalCubicSpline."

Check the attributes of "torchcde."
"""

torchcde.__dict__

"""Find the correct attribute: "natural_cubic_spline_coeffs.""""

X_interpolated = torchcde.natural_cubic_spline_coeffs(coeffs)

X_interpolated

"""Probably this is not what we are looking for, since in "torchcde.cdeint()" the argument "t" does not require a tensor as the input.

Try "torchcde.CubicSpline()" instead.
"""

X_interpolated = torchcde.CubicSpline(coeffs)

X_interpolated

"""The output is strange to me.

If tring "NaturalCubicSpline()" in "controldiffeq," get the following error.
"""

X_interpolated = controldiffeq.NaturalCubicSpline(t, coeffs)

"""Create a neural CDE system."""
...
"""Integrate the data and the system."""

torchcde.cdeint(X=X_interpolated, func=func, z0=z0, t=X_interpolated.interval)

"""Need to interpret the result above.
